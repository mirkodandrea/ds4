...
extern "C" int ds4_gpu_commit_and_wait_current(void) { return cuda_ok(cudaDeviceSynchronize(), "commit_and_wait_current"); }
extern "C" int ds4_gpu_commit_current(void) { return cuda_ok(cudaDeviceSynchronize(), "commit_current"); }
extern "C" int ds4_gpu_wait_committed(void) { return 1; /* CUDA sync already done in commit_current */ }
